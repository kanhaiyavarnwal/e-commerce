  ...
  return (
    <div>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full rounded max-w-[500px] px-3 py-2' type="text" placeholder='Type Here'  required/>
      </div>


      <div className='w-full'>
          <p className='mb-2'>Product description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full rounded max-w-[500px] px-3 py-2' type="text" placeholder='Write Content here'  required/>
      </div>
      ...
      <div>
        ...
        <button type='submit' className='w-28 py-3 mt-4 bg-green-700 text-white rounded-br-3xl'>ADD</button>
      </form>
